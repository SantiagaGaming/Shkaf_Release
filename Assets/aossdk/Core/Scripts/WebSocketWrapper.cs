...
namespace AosSdk.Core.Scripts
{
    ...
    {
        [SerializeField] private int socketPort = 8080;
        ...
        public void Init(IPAddress ip, int port)
        {
            ...
            _serverSocket.Bind(new IPEndPoint(IPAddress.Any, socketPort));
        ...
        {
            aosCommandQueueHandler.CommandQueue.Add(JsonUtility.FromJson<AosCommand>(message));
        }
